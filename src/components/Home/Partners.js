...
const Partners = () => {
  return (
    <div id="partners" className="main">
      ...
      <div className="grid items-center mt-8 px-30 grid-cols-2 gap-x-4 gap-y-10 px-8 md:grid-cols-4 md:gap-x-4 md:gap-y-12 lg:grid-cols-4 lg:gap-x-8 lg:gap-y-12 xl:px-40">
