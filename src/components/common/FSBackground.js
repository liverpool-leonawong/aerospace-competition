  ...
  return (
    <>
      <div className="bg-space">
        ...
        <div className="robotic_front1 sm:hidden lg:inline-block">
          <div className="function-title" onClick={() => setFunction1(!function1)}>拍攝<PlayCircleOutlineRounded /></div>
        </div>
        <div className="robotic_side2 sm:hidden lg:inline-block">
          <div className="function-title" onClick={() => setFunction3(!function3)}>語音 <PlayCircleOutlineRounded /></div>
        </div>
        <div className="robotic_side1">
          <div className="function-title sm:hidden lg:inline-block" onClick={() => setFunction2(!function2)}>避障 <PlayCircleOutlineRounded /></div>
        </div>
        <FsLightbox
          toggler={function1}
          sources={[
